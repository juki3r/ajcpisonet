                ...
                <div class="p-4 text-gray-900">
                    <div class="card">
                        <div class="card-header">
                            <h4>Clients</h4>
                            <svg onclick="printTable('table2')" class="cursor-pointer" width="16" height="16"
                                    ...
                                    <tbody>
                                        @foreach ($clientsdata as $item)
                                            <tr class="text-nowrap">
                                                ...
                                                <td>
                                                    @if ($item->accountNumber == null)
                                                        <a href="{{ route('admindashboard') }}"
                                                            ...
                                                            onclick="return confirm('Account number needed !')">
                                                    ...
                                                    @else
                                                        <a href="{{ url('clients/' . $item->id . '/bill') }}"
                                                            class="btn btn-primary mx-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor"
                                                                class="bi bi-currency-dollar" viewBox="0 0 16 16">
                                                ...
                                                <td>
                                                    <a href="{{ route('edit', [$item->id, $item->fullname, $item->address, $item->accountNumber, $item->plan]) }}"
                                                ...
                                                {{-- <td>
                                                    <a href="{{ url('clients/' . $item->id . '/delete') }}"
                                                        class="btn btn-danger delete mx-1"
