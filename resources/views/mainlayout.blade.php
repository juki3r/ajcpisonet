        ...
        <div class="row p-5" style="background-color: rgb(17, 37, 41)">
            <div class="col-12 col-md-4 d-flex justify-content-center flex-column text-light  p-3 ">
                <h1 class="text-center">
                    <a href="/">
                        <img src="{{asset('assets/ajclogo.png')}}" alt="LOGO"   width="150px">
                    </a>
                </h1>
                <p class="px-lg-5">
                ...
                <p style="margin-top: -20px" class="px-lg-5">
                ...
                <span style="margin-top: -20px" class="px-lg-5">
            ...
            <div class="col-12 col-md-8 p-0 bg-info">
